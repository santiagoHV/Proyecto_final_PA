        ...
        <div class="offset-2 col-5">
            <div class="cardi" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="registroEstudiante.jsp" class="btn-registro  btn-lg btn-block">Registrarme</a>
                </div>
            </div>
        </div>
        <div class="col-5">
            <div class="cardi" style="width: 18rem;">
                ...
                <div class="card-body">
                    ...
                    <a href="registroProfesor.jsp" class="btn-registro  btn-lg btn-block">Registrarme</a>
                </div>
            </div>
        </div>
